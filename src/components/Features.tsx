      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with cutting-edge algorithms and extensive databases to accelerate your research discoveries.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Advanced ML algorithms for pattern recognition in genomic data, protein structure prediction, and biomarker discovery."
            index={0}
          />
          <FeatureCard
            ...
            description="Comprehensive tools for DNA, RNA, and protein sequence analysis including alignment, annotation, and phylogenetic reconstruction."
            index={1}
          />
          <FeatureCard
            ...
            description="Scalable computational infrastructure for large-scale genomic analyses, structural modeling, and systems biology simulations."
            index={2}
          />
          <FeatureCard
            ...
            description="Unified access to major biological databases including GenBank, PDB, UniProt, and specialized omics repositories."
            index={3}
          />
          <FeatureCard
            ...
            description="Enterprise-grade security protocols for sensitive genomic data with HIPAA compliance and encrypted processing pipelines."
            index={4}
          />
          <FeatureCard
            ...
            description="Automated bioinformatics pipelines for NGS data processing, variant calling, and functional annotation with reproducible results."
            index={5}
          />
        </div>
      </div>
