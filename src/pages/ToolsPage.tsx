...
import { ArrowRight, Search, Filter, Database, Wrench, Cpu, BarChart3, Code, GitBranch } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredTools.map((tool, index) => (
              <div
                key={tool.id}
                data-index={index}
                className={`tool-card glass-card p-8 hover:shadow-elegant-hover transition-all duration-500 hover:translate-y-[-5px] group cursor-pointer ${
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-pulse-500 transition-colors duration-300">
                  {tool.name}
                </h3>
                ...
                <button className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-pulse-500 hover:bg-pulse-600 text-white font-medium rounded-xl transition-all duration-300 group-hover:shadow-lg">
                  Access Tool
